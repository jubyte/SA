...
CAPÍTULO 4 - SPRINT RETROSPECTIVE
	...
	O Scrum possui cinco valores principais que ajudam a equipe a trabalhar de forma mais organizada, eficiente e colaborativa. Esses valores melhoram a comunicação, aumentam a produtividade e ajudam no sucesso do projeto. O compromisso faz com que cada integrante cumpra suas responsabilidades e ajude a equipe a alcançar os objetivos da Sprint. A coragem incentiva os membros a enfrentarem desafios, apresentarem ideias e falarem sobre problemas encontrados. O foco ajuda a equipe a se concentrar nas tarefas mais importantes, melhorando a organização e evitando atrasos. Já a abertura incentiva uma comunicação clara e transparente entre todos os participantes do projeto. 
